...
Description : 'Computes the first order autocorrelation of the returns, squared returns and
absolute returns as well as the skewness, kurtosis and Jarque-Bera test statistic for German and
British blue chips, 2004 - 2014.'

Keywords : 'autocorrelation, blue chips, correlation, dax, descriptive-statistics, financial,
jarque-bera-test, kurtosis, log-returns, returns, skewness, statistics'
